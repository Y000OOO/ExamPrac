...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-02-2023 a las 16:01:04
...
(82, 'Productos de limpieza', '2022-06-25'),
(83, 'Abarrotes', '2022-06-25'),
(88, 'Productos para el aseo personal', '2022-09-26'),
(101, 'Carniceria', '2023-02-09');
...
(3, 'Milka', 'Castro', 'Chávez', 'io', 'si00', 'Admi');
...
--
ALTER TABLE `categorias`
  MODIFY `id_categoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
